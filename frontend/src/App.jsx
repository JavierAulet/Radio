...
function RadioPlayer() {
  ...
  const handleShare = async () => {
    const data = {
      title: 'Urbanova Radio',
      text: `🎵 Escuchando ${radioInfo.currentSong} en Urbanova Radio — música urbana 24/7`,
    ...
    <div className="page-wrapper">
      ...
      <header className="sticky-player glass-panel">
        ...
        <div className="sp-right">
          ...
          <button className="btn-icon" onClick={handleShare} title="Compartir" style={{ opacity: 0.7 }}>
            <Share2 size={16} />
          </button>
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          ...
          <div className="hero-bottom-row">
            ...
            <button className="btn-share-pill" onClick={handleShare} title="Compartir radio">
              <Share2 size={14} />
            </button>
          </div>
        </div>
      ...
      <footer className="site-footer">
        ...
        <div className="footer-socials">
          <a href="https://www.instagram.com/urbanovaradio/" target="_blank" rel="noopener noreferrer" className="footer-social-link" title="Instagram">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/>
            </svg>
          </a>
          <a href="https://www.tiktok.com/@urbanovaradio" target="_blank" rel="noopener noreferrer" className="footer-social-link" title="TikTok">
